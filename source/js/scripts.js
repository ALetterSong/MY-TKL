function dispatch() {
    ...
    if (searchval != "") {
        var url = 'http://www.google.com/search?q=site:haoduoyu.cc/%20' + searchval;
...
$(document).ready(function($) {
    ...
    var wall_number = "url(http://7xq3d5.com1.z0.glb.clouddn.com/wall-"+Math.ceil(Math.random()*21)+".jpg)";
